...
firebase.initializeApp({
    ...
    apiKey: "AIzaSyA0NrE8teoT761biKx9DUlfxVRmk7tF9pU",
    authDomain: "manoj-firechat.firebaseapp.com",
    projectId: "manoj-firechat",
    storageBucket: "manoj-firechat.appspot.com",
    messagingSenderId: "566892246033",
    appId: "1:566892246033:web:81a98ab2e24be23dceedb0"
...
function App() {
  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-coolDark-500 dark:text-white transition-colors">
      ...
      >
        <a href="/">
          <h1 className=" mb-2 text-2xl font-bold flex">FireChat</h1>
        </a>
